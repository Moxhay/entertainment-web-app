...
export const apiUrl = 'https://strapi-entertainment-web-app.onrender.com/api/'
export const apiPort = ''
export const baseUrl =
    apiUrl + apiPort || 'https://strapi-entertainment-web-app.onrender.com/api/'
