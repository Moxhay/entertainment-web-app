...
const NavBar = () => {
    ...
    return (
        <div>
            <div className="flex h-full justify-between bg-secondaryDarkBlue px-4 py-5 lg:px-10 xl:justify-start xl:rounded-full">
                <NavButton logo={<MovieLogo />} to={'/'} />
                <div className="flex h-full items-center space-x-6 sm:space-x-8 xl:space-x-9">
                    <NavButton logo={<HomeIcon bg={home} />} to={'/'} />
                    <NavButton logo={<MovieIcon bg={movie} />} to={'/Movies'} />
                    <NavButton logo={<TvIcon bg={tv} />} to={'/TvShow'} />
                    <NavButton
                        logo={<Bookmark bg={bookmark} />}
                        to={'/Bookmark'}
                    />
                </div>
                <div>
